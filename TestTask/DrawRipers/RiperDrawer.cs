...
namespace TestTask.FrameControl
{
    ...
    internal sealed class RiperDrawer : IRiperDrawer
    {
        private readonly List<Point> _landmarks;
        private readonly int _maxLandmarks;

        public RiperDrawer(List<Point> landmarks, int maxLandmarks)
        {
        ...
        public void DrawRipers(PaintEventArgs e, string coordinate, ShapeType shapeType)
        {
            if (e == null)
